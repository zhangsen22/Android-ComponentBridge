package com.zs.npm.impl.serviceload;
...
public class ServiceLoaderTransform extends Transform {
    ...
    public void transform(TransformInvocation invocation) {
        ServiceLoaderLogger.info(TRANSFORM + "start...");
        ServiceLoaderLogger.info(TRANSFORM + INIT_SERVICE_DIR);
        ServiceLoaderLogger.info(TRANSFORM + INIT_SERVICE_PATH);
        ...
        ServiceLoaderLogger.info(TRANSFORM + "cost %s ms", System.currentTimeMillis() - ms);
    }
